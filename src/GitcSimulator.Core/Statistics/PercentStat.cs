...
{
	public class PercentStat : IStat<Percent>, ISnapshotAble<PercentStat>
	{
		...
		public static implicit operator Percent(PercentStat value)
		{
			return value.CurrentValue;
		}

		public static Percent operator +(PercentStat a, PercentStat b)
		{
		...
		public static Percent operator *(PercentStat a, Percent b)
		{
