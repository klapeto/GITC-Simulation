...
namespace GitcSimulator.Core.Statistics
{
		...
		where TConverter : IValueConverter<T>, new()
	{
		...
		protected BaseStat(T baseValue)
		{
		...
		public static implicit operator T(BaseStat<T, TConverter> value)
		{
			return value.CurrentValue;
		}

		public static T operator +(BaseStat<T, TConverter> a, BaseStat<T, TConverter> b)
		{
		...
		public static T operator *(BaseStat<T, TConverter> a, Percent b)
		{
			return FromDouble(a._currentValue * b.ToDouble());
		}

		public static T operator +(BaseStat<T, TConverter> a, double b)
		{
