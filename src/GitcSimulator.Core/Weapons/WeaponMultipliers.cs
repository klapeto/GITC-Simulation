...
namespace GitcSimulator.Core.Weapons
{
	public static class WeaponMultipliers
	{
		...
		public static readonly IReadOnlyDictionary<Quality, IReadOnlyDictionary<AscensionLevel, double>>
			...
			{
				[Quality.OneStar] = new Dictionary<AscensionLevel, double>
				{
				...
				{
					[AscensionLevel.None] = 0.0,
					[AscensionLevel.First] = 19.5,
					[AscensionLevel.Second] = 38.9,
				...
				{
					[AscensionLevel.None] = 0.0,
					[AscensionLevel.First] = 25.9,
					[AscensionLevel.Second] = 51.9,
				...
				{
					[AscensionLevel.None] = 0.0,
					[AscensionLevel.First] = 31.1,
					[AscensionLevel.Second] = 62.2,
		...
		public static readonly IReadOnlyDictionary<MultiplierTier, double[]> ThreeStarMultipliers =
			new Dictionary<MultiplierTier, double[]>
			{
				[MultiplierTier.Tier1] =
				[
					1.0,
					1.071,
					1.141,
